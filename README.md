...
sudo pacman -S rofi
sudo pacman -S kwallet-pam network-manager-applet kwalletmanager waybar qt6ct pcmanfm-gtk3 hyprlock breeze-gtk nwg-look rofi-calc zsh qt5-graphicaleffects flatpak python-beautifulsoup4
yay -S wdisplays qt5-wayland qt6-wayland
yay -S bauh
```
