...
sudo pacman -S rofi
sudo pacman -S kwallet-pam network-manager-applet kwalletmanager waybar qt6ct hyprlock breeze-gtk nwg-look rofi-calc zsh qt5-graphicaleffects flatpak python-beautifulsoup4 ttf-recursive-nerd
...
yay -S remmina-plugin-folder remmina-plugin-open remmina-plugin-rdesktop
```
